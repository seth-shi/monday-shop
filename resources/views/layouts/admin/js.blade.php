...
<script type="text/javascript" src="{{ asset('assets/admin/static/h-ui.admin/js/H-ui.admin.js') }}"></script>
<script type="text/javascript" src="{{ asset('assets/admin/static/h-ui.admin/js/bootstrap.min.js') }}"></script>
