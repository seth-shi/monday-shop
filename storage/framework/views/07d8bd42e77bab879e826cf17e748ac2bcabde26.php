...
<div id="pageWrapper" class="page-wrapper">
    <!-- –––––––––––––––[ HEADER ]––––––––––––––– -->
    <?php echo $__env->make('common.home.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make('common.home.search', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <!-- –––––––––––––––[ HEADER ]––––––––––––––– -->
    ...
    <?php echo $__env->make('common.home.area', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <!-- –––––––––––––––[ FOOTER ]––––––––––––––– -->
    <?php echo $__env->make('common.home.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <!-- –––––––––––––––[ END FOOTER ]––––––––––––––– -->
