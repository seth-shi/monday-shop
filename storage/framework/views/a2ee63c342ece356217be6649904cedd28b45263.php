                        ...
                        <div class="error-page-wrapper t-center">
                            ...
                            <div class="error-page-footer">
                                ...
                                <h2 class="t-uppercase m-10 color-green">
                                    <?php echo e($exception->getMessage()  ? $exception->getMessage() : '您访问的页面不存在~ '); ?>
                            ...
                            <!-- 判断当前路由是否是后台的 -->
                            <a href="<?php echo e(str_contains(url()->current(), 'admin') ? url('/admin/welcome') : url('/')); ?>" class="btn btn-rounded">去首页</a>
                        </div>
                    </div>
                </section>
            </div>
